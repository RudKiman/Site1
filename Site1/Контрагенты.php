...
if($result = $conn->query($sql)){
    ...
    foreach($result as $row){
        ...
        echo "<td><a href='user.php?id=" . $row["id"] . "'>Изменить</a></td>";
...
<a href="counterparty.php" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-1">Добавить</a>
</div>
</section>
